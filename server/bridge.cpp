...
void Bridge::initServices(){
	/*
	// Call parent class method
	ClipsBridge::initServices();
...
void Bridge::initPublishers(){
	// Call parent class method
	ClipsBridge::initPublishers();
...
void Bridge::initSubscriptions(){
	// Call parent class method
	ClipsBridge::initSubscriptions();
...
bool Bridge::srvQueryKDB(QueryKDB::Request& req, QueryKDB::Response& res){
